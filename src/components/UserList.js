...
const UserList = () => {
  ...
  return (
    <div>
      <div>
        <button onClick={ () => setCountUsers( countUsers - 1 ) } hidden={ countUsers === 1 }>Anterior</button>
        <button onClick={ () => setCountUsers( countUsers + 1 ) } hidden={ countUsers >= 10 }>Siguiente</button>
      </div>
